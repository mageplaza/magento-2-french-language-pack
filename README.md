...
2. [Install French Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active French language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active French language pack {#active}
